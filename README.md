...
For any business, a multitude of factors contribute towards governing success including: total product sales, pricing, adequate staffing, budgeting cost, and more. Through an analysis of sales information for a given week, along with expenses surrounding employee labor, action items can be directed towards increasing revenue, capitalizing on customer preferences, and decrease unneccessary expenses. 

## Methodology

The coffee shop data was consolidated from multiple tables into a single view through a query written in Microsoft SQL Server; this allowed for an analysis to be performed, and dashboard to be developed through Tableau, towards analyzing total sales by day of the week, total sales by product type, product size, customer/employee, and whether it was dine in or take out.
...
4. Product information, sales information, employee performance
